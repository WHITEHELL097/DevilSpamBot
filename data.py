RAID = [
    "𝐓𝐄𝐑𝐈 𝐌𝐀𝐀 𝐊𝐈 𝐍𝐔𝐃𝐄𝐒 𝐁𝐄𝐄𝐂𝐇 𝐀𝐀𝐘𝐀 𝐃𝐄𝐕𝐈𝐋", 
    "𝐓𝐄𝐑𝐈 𝐌𝐀𝐀 𝐊𝐎 𝐃𝐄𝐕𝐈𝐋 𝐍𝐄 𝐈𝐓𝐍𝐀 𝐏𝐄𝐋 𝐃𝐈𝐘𝐀 𝐊𝐈 𝐑𝐎 𝐑𝐇𝐈 𝐇 𝐖𝐎 𝐌𝐀𝐃𝐀𝐑𝐂𝐇𝐎𝐃", 
    "𝐃𝐄𝐕𝐈𝐋 𝐓𝐄𝐑𝐀 𝐁𝐀𝐀𝐏 𝐇𝐀𝐈 𝐎𝐑 𝐁𝐀𝐀𝐏 𝐒𝐄 𝐁𝐀𝐊𝐂𝐇𝐎𝐃𝐈 𝐍𝐀𝐇𝐈 𝐒𝐌𝐉𝐇𝐀 𝐋𝐎𝐃𝐄", 
    ...
    "𝙏𝙀𝙍𝙄 𝙈𝘼𝘼 𝙆𝙊 𝘿𝙀𝙑𝙄𝙇 𝙉𝙀 𝙄𝙏𝙉𝘼 𝙋𝙀𝙇 𝘿𝙄𝙔𝘼 𝙆𝙄 𝙍𝙊 𝙍𝙃𝙄 𝙃 𝙈𝘼𝘿𝘼𝙍𝘾𝙃𝙊𝘿", 
    "𝘿𝙀𝙑𝙄𝙇 𝙏𝙀𝙍𝙄 𝙈𝘼𝘼 𝙆𝙆 𝙂𝘽 𝙍𝙊𝘼𝘿 𝙋𝙀 𝘽𝙀𝙀𝘾𝙃 𝘼𝘼𝙔𝘼 𝘽𝙎𝘿𝙆", 
...
REPLYRAID = [
    ...
    "NALLEE",
    "Devil teri maa ko gb road pe beech aaya", 
    "Teri maa ko devil ne itna pel diya ki uski chut ftt k blackhole bnn gyi", 
    "BOLA THA DEVIL SE PANGE NAHI BSDK BEECH AAYA NA TERI MAA KI NUDES", 
    "DEVIL TERI MAA KO PELE JAA RHA H ROK SKTA TOH ROK LE", 
...
MRAID = [
    " Bnn jaa bnn ja tu meri ishq e di chaasni"
...
SRAID = [
    "Mohabbat ka bhram rkh lo, wafa ki shaan bnn jao, ya meri jaan lelo ya meri jaan bnn jao",
    "Lagi thi mujhe bukh chhoti..,Khaai maine 2 roti, dekh ke tujhko hotty,Aagyi mujhe potyyy😂😂😂",
